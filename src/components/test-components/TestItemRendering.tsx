...
export default function TestItemRendering(): React.ReactElement {
    return (
        <div>
            <div><strong>DEBUG:</strong> All items currently implemented.<hr /></div>
            <div style={{ display: "flex", flexWrap: "wrap" }}>
                ...
                <ItemBlock itemName="skulltula-token" count={{ current: 0, max: 100 }} />
                <ItemBlock itemName="triforce" count={{ current: 0, max: 9999 }} />
